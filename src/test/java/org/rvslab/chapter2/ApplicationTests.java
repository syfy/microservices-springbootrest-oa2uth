...
/*
	...
	public void testVanillaService() {
		...
		Greet greet = restTemplate.getForObject("http://localhost:" + env.getProperty("server.port"), Greet.class);
		Assert.assertEquals("Hello World!", greet.getMessage());
	}

	@Test
	public void testSecureService() {
		//System.out.println("pw: "+env.getProperty("security.user.password"));
